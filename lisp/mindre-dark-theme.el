...
(mindre-with-color-variables
  (let ((mindre-heading-1-height (if mindre-use-more-bold 1.0 1.1))
	(faded-color (if mindre-use-more-fading "#bcbcbc" gray-dark)))
    ...
    ;; --- Dired --------------------------------------------------------
    `(dired-header ((t (:foreground ,peach :inherit mindre-bold))))
